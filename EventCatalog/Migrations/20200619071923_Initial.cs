    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventsCatalogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventsCatalogs_EventCategories_EventCategoryId",
                        column: x => x.EventCategoryId,
                        principalTable: "EventCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventsCatalogs_EventLocations_EventLocationId",
                        column: x => x.EventLocationId,
                        principalTable: "EventLocations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventsCatalogs_EventTypes_EventTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventsCatalogs_EventCategoryId",
                table: "EventsCatalogs",
                column: "EventCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_EventsCatalogs_EventLocationId",
                table: "EventsCatalogs",
                column: "EventLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_EventsCatalogs_EventTypeId",
                table: "EventsCatalogs",
                column: "EventTypeId");
        }
